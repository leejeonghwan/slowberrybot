...
{{
  ...
  "comments": [
    {{"speaker": "홍길동", "party": "민주당", "role": "의원", "quote": "원문에서 핵심 문장을 발췌·정리한 인용", "text": "이 발언의 맥락과 의미를 1문장으로 요약"}},
    {{"speaker": "김철수", "party": "국민의힘", "role": "의원", "quote": "원문에서 핵심 문장을 발췌·정리한 인용", "text": "이 발언의 맥락과 의미를 1문장으로 요약"}}
  ],
...
코멘트 규칙:
- quote: 원문에서 핵심이 되는 1~3문장을 발췌. 원문 표현을 최대한 살리되,
  불필요한 반복·추임새·호칭은 제거. 문장이 길면 "…"으로 중략 가능.
  반드시 발언 원문에 실제로 있는 표현이어야 함.
- text: quote의 맥락과 의미를 1문장으로 요약 (배경 설명용)
